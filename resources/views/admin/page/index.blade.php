@extends('layouts.app', ['title' => 'Page - Admin'])
    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="flex items-center">
            <button class="text-white focus:outline-none bg-gray-600 px-4 py-2 shadow-sm rounded-md">
                <a href="{{ route('admin.page.create') }}">TAMBAH</a>
            </button>
                    ...
                    <thead class="justify-between">
                        <tr class="bg-gray-600 w-full">
                            <th class="px-16 py-2" style="width: 40%">
                                <span class="text-white">JUDUL PAGE</span>
                            </th>
                        ...
                        @forelse($pages as $page)
                            <tr class="border bg-white">
                                ...
                                <td class="px-10 py-2 text-center">
                                    <a href="{{ route('admin.page.edit', $page->id) }}" class="bg-indigo-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">EDIT</a>
                                    <button onClick="destroy(this.id)" id="{{ $page->id }}" class="bg-red-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">HAPUS</button>
                                </td>
                            </tr>
                        @empty
