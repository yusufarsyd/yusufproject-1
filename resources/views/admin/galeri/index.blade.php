...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="p-6 bg-white rounded-md shadow-md">
            <h2 class="text-lg text-gray-700 font-semibold capitalize">UPLOAD FOTO</h2>
            <hr class="mt-4">
                        ...
                        @forelse($galeris as $galeri)
                            <tr class="border bg-white">
                                ...
                                <td class="px-16 py-2 flex justify-center">
                                    <img src="{{ $galeri->image }}" class="object-fit-cover rounded" style="width: 35%">
                                </td>
            
                                <td class="px-10 py-2 text-center">
                                    <button onClick="destroy(this.id)" id="{{ $galeri->id }}" class="bg-red-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">HAPUS</button>
                                </td>
                            </tr>
                        @empty
