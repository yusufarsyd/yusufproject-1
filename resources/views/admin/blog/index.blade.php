    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="flex items-center">
            <button class="text-white focus:outline-none bg-gray-600 px-4 py-2 shadow-sm rounded-md">
                <a href="{{ route('admin.blog.create') }}">TAMBAH</a>
            </button>
                    ...
                    <thead class="justify-between">
                        <tr class="bg-gray-600 w-full">
                            <th class="px-10 py-2" style="width: 40%">
                                <span class="text-white">JUDUL BERITA</span>
                            </th>
                        ...
                        @forelse($blogs as $blog)
                            <tr class="border bg-white">
                                ...
                                <td class="px-5 py-2">
                                 ...
                                 <td class="px-10 py-2">
                                    <img src="{{ $blog->image }}" class="w-10 h-100 object-fit-cover rounded-full">
                                </td>
                                <td class="px-10 py-2 text-center">
                                    <a href="{{ route('admin.blog.edit', $blog->id) }}" class="bg-indigo-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">EDIT</a>
                                    <button onClick="destroy(this.id)" id="{{ $blog->id }}" class="bg-red-600 px-4 py-2 rounded shadow-sm text-xs text-white focus:outline-none">HAPUS</button>
                                </td>
                            </tr>
                        @empty
