...
<div class="flex justify-center items-center h-screen bg-gray-300 px-6">
    <div class="p-6 max-w-sm w-full bg-white shadow-md rounded-md">
                        ...
                        <div class="flex justify-center items-center">
                            <img src="{{ asset('assets/img/elzawa.svg') }}" alt="logo" width="100"
        ...
        <div class="flex justify-center items-center">
            <span class="text-gray-700 font-semibold">LAZ el-ZaWa</span>
        </div>
        @if (session('status'))
        ...
        <form class="mt-4" action="{{ route('login') }}" method="POST">
            ...
            <div class="flex justify-between items-center mt-4">
                ...
                <div>
                    <a class="block text-sm fontme text-green-700 hover:underline" href="/forgot-password">Lupa
                        Password?</a>
                </div>
            </div>
            ...
            <div class="mt-6">
                <button type="submit"
                    class="py-2 px-4 text-center bg-green-700 rounded-md w-full text-white text-sm hover:bg-green-500 focus:outline-none">
                    LOGIN
                </button>
            </div>
        </form>
